...
const menuItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      // { title: 'Báo cáo', path: '/hrm/dashboard', permission: 'VIEW_ATTENDANCE' },
    ]
  },
  {
    ...
    subItems: [
      ...
      // { title: 'Ứng viên', path: '/hrm/users', permission: 'EDIT_USER' },
      { title: 'Báo cáo', path: '/hrm/dashboard', permission: 'VIEW_EMPLOYEE' },
    ]
  },
